    ...
    <div className="min-h-screen bg-[#15171B] text-white font-sans flex flex-col relative">
      ...
      <main className="relative z-10 flex-1 max-w-4xl mx-auto w-full pt-20 px-6 pb-32">
        ...
        <div className="space-y-6 text-zinc-300 leading-relaxed bg-black/20 p-8 md:p-12 rounded-[2rem] border border-white/5 backdrop-blur-sm shadow-2xl">
          <p className="text-lg">Welcome to Vibe. By accessing our application, you agree to be bound by these terms. Please read them carefully before using our anonymous communication services.</p>
          ...
          <p>You agree not to use the application for any unlawful purpose or any purpose prohibited under this clause. You agree not to use the application in any way that could damage the site, the services or the general business of Vibe. You must be at least 18 years old to use our platform.</p>
          ...
          <p>Vibe is a platform for respectful communication. We reserve the right to ban users who exhibit inappropriate behavior, harassment, hate speech, or violate community guidelines on video and audio calls. Nudity and explicit content on camera are strictly forbidden.</p>
          ...
          <p>By default, Vibe operates as an anonymous communication tool. Your peer-to-peer video streams and socket-based text chats are ephemeral. We do not record or retain chat history or video feeds after the session is terminated. However, we do store account identifiers, premium status, and reporting metadata to enforce community safety.</p>
          ...
          <p>In no event shall Vibe, nor its directors, employees, or partners, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
